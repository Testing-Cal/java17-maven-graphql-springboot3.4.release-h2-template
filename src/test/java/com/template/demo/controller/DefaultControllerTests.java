...
public class DefaultControllerTests {
    ...
    private String mockDefaultResponse() {
        return title + "Hello! You have successfully set up your Java17 GraphQL Maven SpringBoot:3.4 environment by using the Lazsa template. You're all set to start coding. " +
            "<br/> <br/>" +
